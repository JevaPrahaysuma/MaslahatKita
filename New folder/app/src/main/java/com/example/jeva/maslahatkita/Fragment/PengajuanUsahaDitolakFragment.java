...
import com.example.jeva.maslahatkita.Adapter.PengajuanUsahaDitolakAdapter;
...
public class PengajuanUsahaDitolakFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.pengajuan_ditolak_fragment, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        database.child("PengajuanUsaha").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new PengajuanUsahaDitolakAdapter(getActivity(),daftarPengajuanUsaha);
                ...
                for (DataSnapshot noteDataSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (pu.getStatusUsaha() == 2 && pu.getMitraId().equals(idMitra) ) {
